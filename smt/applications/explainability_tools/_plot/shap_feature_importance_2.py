from .. import shap_feature_importance_2
import numpy as np


class ShapFeatureImportanceDisplay2:
    ...
    def from_surrogate_model(
        ...
        feature_importance = shap_feature_importance_2(
            x,
            model,
            x,
        )
        display = ShapFeatureImportanceDisplay2(feature_importance, feature_names)
