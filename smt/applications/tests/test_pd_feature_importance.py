...
class TestPDFeatureImportance(SMTestCase):
    def test_pd_feature_importance_numerical(self):
        ...
        pdd_importance = PDFeatureImportanceDisplay.from_surrogate_model(sm, x, feature_names=feature_names)
    ...
    def test_pd_feature_importance_mixed(self):
        ...
        pdd_importance = PDFeatureImportanceDisplay.from_surrogate_model(
            sm, x, feature_names=feature_names, categorical_feature_indices=categorical_feature_indices
        )
        pdd_importance_fig = pdd_importance.plot()
